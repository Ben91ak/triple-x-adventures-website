      ...
      <div className="container mx-auto px-4 pt-16 pb-8 relative" style={{ zIndex: 10 }}>
        ...
        <div className="lg:flex lg:justify-between">
          ...
          <div className="max-w-md mx-auto lg:mx-0 text-center lg:text-left mb-12 lg:mb-0 lg:max-w-xs">
            <Link href="/" className="inline-block">
              <span className="sr-only">Triple X Adventures - Home</span>
              <img 
                src="/weiss-grun.png" 
                alt="Triple X Adventures Logo" 
                className="h-16 w-auto object-contain mb-4 hover:opacity-90 transition-opacity mx-auto lg:mx-0" 
                width="200"
                height="64"
              />
            </Link>
            <div className="w-12 h-1 bg-accent-color rounded-full mx-auto lg:mx-0 mb-4" aria-hidden="true"></div>
            <p className="text-white text-opacity-80 mb-6 leading-relaxed">{content.description}</p>
            
            {/* Social icons in a compact row */}
            <nav aria-label="Social Media Links">
              <ul className="flex space-x-3 justify-center lg:justify-start list-none p-0">
                <li>
                  <a 
                    href="#" 
                    className="w-9 h-9 rounded-full bg-card-bg/80 border border-white/10 flex items-center justify-center text-white hover:text-accent-color hover:border-accent-color/50 transition-colors"
                    aria-label="Facebook"
                    rel="noreferrer"
                  >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-y-10 gap-x-4 sm:gap-x-6 lg:gap-x-12 mt-10 lg:mt-0 lg:max-w-2xl">
            ...
            <div className="col-span-1">
              <nav aria-labelledby="quick-links-heading">
                <h2 id="quick-links-heading" className="text-lg font-semibold mb-4 text-white">
                  <span className="bg-accent-color/20 w-1.5 h-6 mr-2 rounded-full hidden sm:inline-block align-middle" aria-hidden="true"></span>
            ...
            <div className="hidden sm:block col-span-1">
              <nav aria-labelledby="adventures-heading">
                <h2 id="adventures-heading" className="text-lg font-semibold mb-4 text-white">
                  <span className="bg-accent-color/20 w-1.5 h-6 mr-2 rounded-full inline-block align-middle" aria-hidden="true"></span>
                ...
                <address className="not-italic">
                  <ul className="space-y-3 list-none p-0">
                    <li className="flex items-start">
                      <div className="mr-2.5 mt-0.5 w-7 h-7 rounded-full bg-accent-color/10 flex items-center justify-center text-accent-color shadow-glow-sm flex-shrink-0" aria-hidden="true">
                        <MapPin size={14} />
                      </div>
                      <span 
                    ...
                    <li className="flex items-center">
                      <div className="mr-2.5 w-7 h-7 rounded-full bg-accent-color/10 flex items-center justify-center text-accent-color shadow-glow-sm flex-shrink-0" aria-hidden="true">
                        <Phone size={14} />
                      </div>
                      <a href="tel:+46703575455" className="text-white text-opacity-80 text-sm sm:text-base hover:text-accent-color transition-colors">+46 (0) 70 357 5455</a>
                    </li>
                    <li className="flex items-center">
                      <div className="mr-2.5 w-7 h-7 rounded-full bg-accent-color/10 flex items-center justify-center text-accent-color shadow-glow-sm flex-shrink-0" aria-hidden="true">
                        <Mail size={14} />
                      </div>
                      <a href="mailto:info@triple-x-adventures.com" className="text-white text-opacity-80 text-sm sm:text-base break-all hover:text-accent-color transition-colors">info@triple-x-adventures.com</a>
                    </li>
                  </ul>
                </address>
              </section>
        ...
        <div className="border-t border-white/5 pt-6 mt-12 text-center">
          ...
          <nav aria-label="Legal Links">
            <ul className="mt-4 flex flex-wrap justify-center gap-x-6 gap-y-2 list-none p-0">
              {[
